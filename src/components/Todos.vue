...
import { insertTodo, updateAsBoughtTodo, updateAsNotBoughtTodo,  resetTodos, dropTable, createTable, insertAll, fetchTodosBoughtQty, deleteItem } from '@/utils/api'
import { Network } from '@capacitor/network'
import Dots from './Dots.vue'
import Carts from './Carts.vue'
import InputBox from './InputBox.vue'
import Table from './Table.vue'
import { useGetTodos } from '@/composables/useTools'
...
async function getTodos(bought) {
  todos.value = await useGetTodos(bought)
}
